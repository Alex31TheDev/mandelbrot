...
public:
    ...
    void setStatusState(const QString& statusText, const QString& statusLinkPath,
    ...
    [[nodiscard]] bool preserveRatioEnabled() const;
...
private:
    ...
    void _refreshNamedCombo(
        QComboBox* combo, const QStringList& names, const QString& currentName,
        bool dirty) const;
};
