...
FORCE_INLINE void normalFormula_perpendicular_mp(
    ...
    mpfr_mul(s.t[2], s.t[0], s.t[0], MPFRTypes::ROUNDING);
    mpfr_mul(s.t[3], s.t[1], s.t[1], MPFRTypes::ROUNDING);
    mpfr_sub(s.t[2], s.t[2], s.t[3], MPFRTypes::ROUNDING);
    mpfr_add(s.zr, s.t[2], cr, MPFRTypes::ROUNDING);

    mpfr_mul(s.t[3], s.t[0], s.t[1], MPFRTypes::ROUNDING);
    mpfr_mul_2ui(s.t[3], s.t[3], 1, MPFRTypes::ROUNDING);
...
FORCE_INLINE void fractionalFormula_perpendicular_mp(
    mpfr_srcptr cr, mpfr_srcptr ci,
    MPFRScratch &s
) {
    mpfr_abs(s.t[0], s.zr, MPFRTypes::ROUNDING);
...
FORCE_INLINE void normalDerivative_perpendicular_mp(MPFRScratch &s) {
    ...
    mpfr_abs(s.t[3], s.zr, MPFRTypes::ROUNDING);
    mpfr_mul(s.t[4], s.t[3], s.di, MPFRTypes::ROUNDING);
    setSign_mp(s.t[5], s.zr);
    mpfr_mul(s.t[5], s.t[5], s.zi, MPFRTypes::ROUNDING);
    mpfr_mul(s.t[5], s.t[5], s.dr, MPFRTypes::ROUNDING);
    mpfr_add(s.t[6], s.t[4], s.t[5], MPFRTypes::ROUNDING);
...
FORCE_INLINE void wholeDerivative_perpendicular_mp(MPFRScratch &s) {
    setSign_mp(s.t[0], s.zr);
    mpfr_mul(s.t[12], s.t[0], s.dr, MPFRTypes::ROUNDING);
    mpfr_neg(s.t[13], s.di, MPFRTypes::ROUNDING);

    mpfr_abs(s.t[2], s.zr, MPFRTypes::ROUNDING);
    mpfr_neg(s.t[3], s.zi, MPFRTypes::ROUNDING);
...
FORCE_INLINE void fractionalDerivative_perpendicular_mp(MPFRScratch &s) {
    mpfr_abs(s.t[2], s.zr, MPFRTypes::ROUNDING);
    mpfr_neg(s.t[3], s.zi, MPFRTypes::ROUNDING);
